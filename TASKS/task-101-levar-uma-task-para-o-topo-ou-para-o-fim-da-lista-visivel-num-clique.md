...
- [ ] Verificar no dashboard aberto, com o cenario de 500 tasks, quantos arquivos cada botao altera — adiado: o Chromium do Playwright nao sobe neste host. Medido no composable com o cenario da 082 (500 tarefas, 20 numeradas), contando `changedTasks` (o que o dashboard grava): ver `custo no cenario de 500 tarefas` e a tabela nas notas
