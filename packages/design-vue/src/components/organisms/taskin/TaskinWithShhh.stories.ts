...
export const BrunoShhh: Story = {
  ...
  args: {
    ...
    enableNoiseReactions: true,
    noiseThreshold: 0.05,
    // Dois segundos de barulho sustentado antes do primeiro pedido, e dez
    // segundos de silencio do mascote antes do proximo. Uma porta batendo nao
    // atravessa os dois segundos; uma conversa alta atravessa.
    noiseSustainMs: 2000,
    ...
    docs: {
      description: {
        story: [
          ...
          '',
          'Os dois tempos respondem a perguntas diferentes, e aqui estao configurados para o caso real:',
          '`noiseSustainMs` (2000ms) e quanto tempo o barulho precisa se manter acima do limiar ANTES do primeiro',
          'pedido — e o que separa uma porta batendo de uma conversa que ja dura tempo demais. `noiseDebounceMs`',
          '(10000ms) e quanto tempo o mascote fica calado DEPOIS de pedir, para nao virar ele proprio o barulho da',
          'sala. Ambos sao ajustaveis ao vivo no painel de controles da story, com a reacao ligada.',
          '',
