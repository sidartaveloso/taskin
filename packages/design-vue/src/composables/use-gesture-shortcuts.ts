...
export type PrioritizationAction = 'moveUp' | 'moveDown' | 'groupWith' | 'ungroup' | 'undo' | 'copyCard' | 'setDifficulty1' | 'setDifficulty2' | 'setDifficulty3' | 'setDifficulty4' | 'setDifficulty5' | 'none';
